...
//               </div>
//               <div className="p-4">
//                 <p className="font-medium text-white">{product.mode}</p>
//                 <button onClick={()=>route.push(`/products/${product.id}`)}><h3 className="text-white font-bold">{product.name}</h3></button>
...
const Products = () => {
  ...
  return (
    <div className="py-6 sm:py-8 lg:py-10">
      ...
      {/* Top Heading */}
      <div className="flex flex-col gap-4 px-4 sm:px-6 md:flex-row md:items-center md:justify-between lg:px-10">
        <h1 className="ml-0 text-xl font-bold sm:text-2xl md:ml-10">
          New&apos;500&apos;
        </h1>
        ...
        <Image
          ...
          width={250}
          height={250}
          className="h-auto w-[180px] max-w-full self-end sm:w-[220px] md:w-[250px]"
        />
      </div>


      {/* Sidebar + Products */}
      <div className="flex flex-col gap-8 px-4 py-5 sm:px-6 md:px-8 lg:flex-row lg:justify-around lg:gap-10 lg:px-10">
        ...
        <div className="mx-auto w-full max-w-7xl px-0 sm:px-2">
          ...
          <h1 className="my-2 text-2xl font-bold sm:text-3xl">
              ...
              >
                ...
                <div className="relative flex justify-center">
                  <Image
                    ...
                    width={270}
                    height={250}
                    className="h-auto w-full max-w-[270px] object-cover"
                  />
                </div>
      ...
      <div className="p-4 sm:p-6">
        ...
        <h1 className="text-center text-2xl font-bold text-[#111111] sm:text-left">
          Related Categories
        </h1>

        <br />

        <div className="mt-4 grid grid-cols-1 justify-center gap-4 sm:grid-cols-2 lg:grid-cols-3">

          <button className="rounded-full border bg-[#FFFFFF] px-4 py-2 text-[#111111]">
            Best Selling Products
          </button>
